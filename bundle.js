...
var $author$project$MergeSort$mergeSteps = F4(
	function (l1, l2, i1, i2) {
		...
		if (!_v0.a.b) {
			return _Utils_Tuple3(l2, _List_Nil, _List_Nil);
		} else {
			if (!_v0.b.b) {
				return _Utils_Tuple3(l1, _List_Nil, _List_Nil);
			} else {
				var _v1 = _v0.a;
				var e1 = _v1.a;
				var r1 = _v1.b;
			...
			switch (msg.$) {
				...
				case 'Tick':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{currentLeft: newLeft, currentRight: newRight, currentStep: newCurr, index: newIndex}),
				...
				case 'Back':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								index: A2($elm$core$Basics$max, 0, model.index - 1)
							}),
						$elm$core$Platform$Cmd$none);
				case 'Advance':
					return _Utils_Tuple2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Update$Roll)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Update$Back),
						$elm$html$Html$Attributes$disabled(model.index <= 0)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('<')
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Update$Pause),
						$elm$html$Html$Attributes$disabled(model.pause)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Update$Continue),
						$elm$html$Html$Attributes$disabled(!model.pause)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Update$Advance),
